<div class="col-12 col-md-4">
	...
	<article <?php post_class('trawell-item item-overlay trawell-item-color-overlay text-center'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image('trawell-c3'); ?>
		...
		<div class="entry-header element-pos-center">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h5 md-h5 sm-h4 no-margin"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
