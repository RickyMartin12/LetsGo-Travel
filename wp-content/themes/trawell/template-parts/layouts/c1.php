<div class="col-12">
	...
	<article <?php post_class('trawell-item item-overlay trawell-item-color-overlay text-center'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image('trawell-c1'); ?>
		...
		<div class="entry-header element-pos-center">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h1 md-h1 sm-h4 no-margin trawell-entry md-trawell-entry"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
