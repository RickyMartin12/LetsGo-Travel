<div class="col-12 col-md-6">
	<?php $trawell_layout = trawell_get_post_layout_options( 'a2' ); ?>
    <article <?php post_class( 'trawell-item' ); ?>>
		
		<?php $trawell_featured_image = trawell_get_featured_image( 'trawell-a2-sid' ); ?>
        ...
        <div class="entry-header">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h4 sm-h2 m-h1"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
