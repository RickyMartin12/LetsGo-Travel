<div class="col-12 col-md-4">
	...
	<?php $trawell_layout = trawell_get_post_layout_options( 'e3' ); ?>
	<article <?php post_class('trawell-item'); ?>>
			...
			<div class="entry-header">
				...
				<?php the_title( sprintf( '<h3 class="entry-title h4 md-h4 sm-h2 no-margin"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
