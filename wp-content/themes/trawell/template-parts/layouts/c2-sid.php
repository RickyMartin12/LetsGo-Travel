<div class="col-12 col-md-6">
	...
	<article <?php post_class('trawell-item item-overlay trawell-item-color-overlay text-center'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image('trawell-c2-sid'); ?>
		...
		<div class="entry-header element-pos-center">
			...
			<?php if(!empty($trawell_layout['meta'])): ?>
                <div class="entry-meta entry-metal-small"><?php echo trawell_get_meta_data( $trawell_layout['meta'] ); ?></div>
			<?php endif; ?>
		</div>
