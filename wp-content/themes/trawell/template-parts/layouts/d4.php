<div class="col-12 col-sm-6 col-md-3">
	...
	<?php $trawell_layout = trawell_get_post_layout_options( 'd4' ); ?>
	<article <?php post_class('trawell-item item-overlay trawell-item-gradient'); ?>>

		<?php $trawell_featured_image = trawell_get_featured_image('trawell-d4'); ?>
		...
		<div class="entry-header element-pos-abs element-pos-bottom">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h6 md-h6 sm-h4 m-h1 no-margin"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
