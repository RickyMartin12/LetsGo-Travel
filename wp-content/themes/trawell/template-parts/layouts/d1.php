<div class="col-12">
	...
	<article <?php post_class('trawell-item item-overlay trawell-item-gradient'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image('trawell-d1'); ?>
		...
		<div class="entry-header trawell-entry element-pos-abs element-pos-bottom">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h1 md-h1 sm-h4"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
