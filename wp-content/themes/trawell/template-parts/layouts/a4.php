<div class="col-12 col-sm-6 col-md-3">
	...
	<article <?php post_class('trawell-item'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image( 'trawell-a4' ); ?>
		...
		<div class="entry-header">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h5 md-h5 sm-h3 m-h1"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
