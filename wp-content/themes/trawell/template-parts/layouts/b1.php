<div class="col-12">
	...
	<?php $trawell_layout = trawell_get_post_layout_options( 'b1' ); ?>
	<article <?php post_class('trawell-item row'); ?>>

		<div class="col-12 col-md-6">
			<?php $trawell_featured_image = trawell_get_featured_image( 'trawell-b1'); ?>
		...
		<div class="col-12 col-md-6">	
			<div class="entry-header">
				...
				<?php the_title( sprintf( '<h3 class="entry-title h2 md-h3 sm-h3"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
