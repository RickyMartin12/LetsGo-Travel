<div class="col-12 col-md-4">
	...
	<article <?php post_class('trawell-item item-overlay trawell-item-color-overlay text-center cat-item cat-item-'.$category->term_id ); ?>>
		...
		<?php if( $featured_image = trawell_get_category_featured_image('trawell-cat-c3', $category->term_id) ): ?>
		...
		<div class="entry-header element-pos-center">
			<h3 class="entry-title h2 md-h4 sm-h2 no-margin"><a href="<?php echo get_category_link($category->term_id); ?>"><?php echo esc_html( $category->name ); ?></a></h3>
