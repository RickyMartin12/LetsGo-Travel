<div class="col-12 col-md-6 col-lg-4">
	...
	<?php $trawell_layout = trawell_get_post_layout_options( 'b3' ); ?>
	<article <?php post_class('trawell-item row'); ?>>

		<div class="col-5">
			<?php $trawell_featured_image = trawell_get_featured_image('trawell-b3'); ?>
		...
		<div class="col-7 no-left-padding">	
			<div class="entry-header">
				...
				<?php the_title( sprintf( '<h3 class="entry-title h6 sm-h6"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
