<div class="col-12 col-md-6">
	...
	<article <?php post_class('trawell-item item-overlay trawell-item-gradient'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image('trawell-d2'); ?>
		...
		<div class="entry-header element-pos-abs element-pos-bottom">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h2 md-h4 sm-h5 no-margin"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
