<div class="col-12 col-md-4">
	...
	<article <?php post_class('trawell-item item-overlay trawell-item-gradient cat-item cat-item-'.$category->term_id); ?>>
		...
		<?php if( $featured_image = trawell_get_category_featured_image('trawell-cat-d3-sid', $category->term_id) ): ?>
		...
		<div class="entry-header element-pos-abs element-pos-bottom">
			<h3 class="entry-title h4 md-h2 no-margin"><a href="<?php echo get_category_link($category->term_id); ?>"><?php echo esc_html( $category->name ); ?></a></h3>
