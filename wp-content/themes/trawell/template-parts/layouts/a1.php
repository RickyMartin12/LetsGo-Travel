<div class="col-12">
	...
	<article <?php post_class('trawell-item'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image( 'trawell-a1' ); ?>
		...
		<div class="trawell-entry">
            <div class="entry-header">
				...
				<?php the_title( sprintf( '<h3 class="entry-title h1 md-h1 sm-h1"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
