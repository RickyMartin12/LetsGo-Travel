<div class="col-12 col-md-6">
	...
	<?php $trawell_layout = trawell_get_post_layout_options( 'c2' ); ?>
	<article <?php post_class('trawell-item item-overlay trawell-item-color-overlay text-center'); ?>>

		<?php $trawell_featured_image = trawell_get_featured_image('trawell-c2'); ?>
		...
		<div class="entry-header element-pos-center">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h2 md-h4 sm-h4 no-margin"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
