<div class="col-12 col-md-4">
	...
	<article <?php post_class('trawell-item'); ?>>
		...
		<?php $trawell_featured_image = trawell_get_featured_image( 'trawell-a3-sid' ); ?>
		...
		<div class="entry-header">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h5 sm-h3"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
