<div class="col-12 col-md-4">
	...
	<?php $trawell_layout = trawell_get_post_layout_options( 'd3' ); ?>
	<article <?php post_class('trawell-item item-overlay trawell-item-gradient'); ?>>

		<?php $trawell_featured_image = trawell_get_featured_image('trawell-d3-sid'); ?>
		...
		<div class="entry-header element-pos-abs element-pos-bottom">
			...
			<?php the_title( sprintf( '<h3 class="entry-title h6 sm-h5 m-h1 no-margin"><a href="%s">', esc_url( get_permalink() ) ), '</a></h3>' ); ?>
